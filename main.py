...
class BrandDNAAnalyzer:
    ...
    async def analyze_brands_with_data(
        self,
        brand_configs: List[Dict],
        output_dir: Path = None
    ) -> tuple:
        """
        Complete brand DNA analysis workflow returning both report and data
        ...
        Returns:
            Tuple of (report_path, brands_data, strategic_insights)
        """
        output_dir = output_dir or config.OUTPUT_DIR
        start_time = datetime.now()
        ...
        return report_path, brands_data, strategic_insights
