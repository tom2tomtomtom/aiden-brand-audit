...
| `STRIPE_PRICE_ID_PRO` | (removed) | Stripe price ID for Pro plan |
| `STRIPE_PRICE_ID_AGENCY` | (removed) | Stripe price ID for Agency plan |
...
6. **Strategic Analysis**: Messaging themes, tone and voice, white space opportunities, recommended actions
