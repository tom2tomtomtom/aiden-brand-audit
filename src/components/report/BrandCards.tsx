      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
        {brands.map((brand) => (
          ...
          >
            ...
            <p className="text-xs text-white-dim font-geist-mono mb-4">{brand.website}</p>
            ...
            <div className="grid grid-cols-3 gap-2 pt-4 border-t border-border-subtle">
              <div className="text-center">
                <div className="flex items-center justify-center gap-1 mb-1">
                  <Globe className="h-3 w-3 text-white-dim" />
                </div>
                <p className="text-lg font-bold text-red-hot tabular-nums">{brand.ads.length}</p>
                <p className="text-[10px] text-white-dim uppercase">Ads</p>
              </div>
              <div className="text-center">
                <div className="flex items-center justify-center gap-1 mb-1">
                  <ImageIcon className="h-3 w-3 text-white-dim" />
                </div>
                <p className="text-lg font-bold text-red-hot tabular-nums">{brand.screenshots.length}</p>
                <p className="text-[10px] text-white-dim uppercase">Images</p>
              </div>
              <div className="text-center">
                <div className="flex items-center justify-center gap-1 mb-1">
                  <Palette className="h-3 w-3 text-white-dim" />
                </div>
                <p className="text-lg font-bold text-red-hot tabular-nums">
                  {brand.colors ? brand.colors.primaryColors.length + brand.colors.secondaryColors.length : 0}
                </p>
                <p className="text-[10px] text-white-dim uppercase">Colors</p>
              </div>
            </div>
          </div>
        ))}
